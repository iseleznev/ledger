 ...
 */
public class SWSRStripeEventLoop implements Runnable {
    ...
    static {
        try {
            ...
            RUNNING_VAR_HANDLE = lookup.findVarHandle(
                SWSRStripeEventLoop.class, "running", boolean.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }

    private final SWSRRingBufferHandler ringBuffer;
    private final RingBufferProcessor[] processorStripe;
    private final int expectedBatchSize;
    ...
    public SWSRStripeEventLoop(
        SWSRRingBufferHandler ringBuffer,
    ...
    public SWSRRingBufferHandler getRingBuffer() {
        return ringBuffer;
    }
}
