...
public class PipelineSWSRRingBufferHandler {
    ...
    public PipelineSWSRRingBufferHandler(MemorySegment memorySegment) {
     ...
     */
    public boolean tryStampForward(RingBufferStamper ringBufferStamper, long pipelineProcessOffset, long walSequenceId, long stateSequenceId, int maxAttempts) {
        ...
        for (int attempt = 0; attempt < maxAttempts; attempt++) {
            ...
            long currentProcessOffset = pipelineProcessOffset;
            ...
            ringBufferStamper.stamp(memorySegment, currentProcessOffset, availableSize, walSequenceId, stateSequenceId);
    ...
    public long tryProcess(
        ...
        final long currentProcessOffset = processor.pipelineProcessOffset();
        final long stateSequenceId = (long) STATE_SEQUENCE_ID_VAR_HANDLE.get(this);
        final long walSequenceId = (long) WAL_SEQUENCE_ID_VAR_HANDLE.get(this);
        ...
        return processor.process(memorySegment, arenaSize, stampOffset, availableSize, walSequenceId, stateSequenceId);
    }
