...
@Slf4j
public class PostgresRingBufferProcessor implements RingBufferProcessor {

    private final DirectPostgresBatchSender<PostgreSqlEntryRecordRingBufferHandler> directSender;
    private final int workerId;

    public PostgresRingBufferProcessor(DirectPostgresBatchSender<PostgreSqlEntryRecordRingBufferHandler> directSender, int workerId) {
        this.directSender = directSender;
        this.workerId = workerId;
    }

    @Override
    public long process(RingBufferHandler ringBufferHandler, long batchSlotOffset, long batchRawSize) {
...
//    }
     ...
     */
    private boolean validateBatchChecksum(RingBufferHandler ringBufferLayout, long batchOffset, long expectedChecksum) {
        try {
