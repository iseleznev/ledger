...
@Slf4j
public class PostgresEntryRecordCheckpointWriter {
    ...
    public PostgresEntryRecordCheckpointWriter(String path, int shardId) {
...
//        this.walFileOffset.set(walFileOffset);
    ...
    private String newCheckpointFilename(String newFilename) {
        return newFilename + "_pg_entry_records_sequence_id.dat";
    }
