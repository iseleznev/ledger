...
public class AccountsFileTableRingBufferStamper implements RingBufferStamper {

    private final MemorySegment fileTableRingBufferMemorySegment;
    private long transferOffset;
    private long debitAccountEntryRecordOrdinal;
    private long creditAccountEntryRecordOrdinal;


    public AccountsFileTableRingBufferStamper(SWSRRingBufferHandler fileTableRingBuffer) {
        this.fileTableRingBufferMemorySegment = fileTableRingBuffer.memorySegment();
    }
    ...
    public void stamp(MemorySegment memorySegment, long stampOffset) {
        stampAccountState(
            memorySegment,
            stampOffset,
            fileTableRingBufferMemorySegment.get(ValueLayout.JAVA_LONG, transferOffset + TRANSFER_DEBIT_ACCOUNT_ID_MSB_OFFSET),
            fileTableRingBufferMemorySegment.get(ValueLayout.JAVA_LONG, transferOffset + TRANSFER_DEBIT_ACCOUNT_ID_LSB_OFFSET),
        ...
        stampAccountState(
            ...
            fileTableRingBufferMemorySegment.get(ValueLayout.JAVA_LONG, transferOffset + TRANSFER_CREDIT_ACCOUNT_ID_MSB_OFFSET),
            fileTableRingBufferMemorySegment.get(ValueLayout.JAVA_LONG, transferOffset + TRANSFER_CREDIT_ACCOUNT_ID_LSB_OFFSET),
    ...
    private void stampAccountState(MemorySegment memorySegment, long stampOffset, long accountIdMsb, long accountIdLsb, short entryType, long ordinal) {
//        memorySegment.set(LENGTH_TYPE, stampOffset + AMOUNT_LENGTH_OFFSET, (short) AMOUNT_TYPE.byteSize());
        memorySegment.set(
            ...
            fileTableRingBufferMemorySegment.get(TRANSFER_AMOUNT_TYPE, transferOffset + TRANSFER_AMOUNT_OFFSET)
        );
//        memorySegment.set(LENGTH_TYPE, stampOffset + ENTRY_TYPE_LENGTH_OFFSET, (short) ENTRY_TYPE_TYPE.byteSize());
        ...
        memorySegment.set(
            ...
            fileTableRingBufferMemorySegment.get(TRANSFER_CREATED_AT_TYPE, transferOffset + TRANSFER_CREATED_AT_OFFSET)
        );
        ...
        memorySegment.set(
            ...
            fileTableRingBufferMemorySegment.get(TRANSFER_ID_TYPE, transferOffset + TRANSFER_ID_MSB_OFFSET)
        );
        memorySegment.set(
            ENTRY_RECORD_TRANSFER_ID_TYPE,
            stampOffset + EntryRecordOffsetConstants.ENTRY_RECORD_TRANSFER_ID_LSB_OFFSET,
            fileTableRingBufferMemorySegment.get(TRANSFER_ID_TYPE, transferOffset + ENTRY_RECORD_TRANSFER_ID_LSB_OFFSET)
        );
        ...
        memorySegment.set(
            ...
            fileTableRingBufferMemorySegment.get(TRANSFER_IDEMPOTENCY_KEY_TYPE, transferOffset + TRANSFER_IDEMPOTENCY_KEY_MSB_OFFSET)
        );
        memorySegment.set(
            IDEMPOTENCY_KEY_TYPE,
            stampOffset + IDEMPOTENCY_KEY_LSB_OFFSET,
            fileTableRingBufferMemorySegment.get(TRANSFER_IDEMPOTENCY_KEY_TYPE, transferOffset + TRANSFER_IDEMPOTENCY_KEY_LSB_OFFSET)
        );
