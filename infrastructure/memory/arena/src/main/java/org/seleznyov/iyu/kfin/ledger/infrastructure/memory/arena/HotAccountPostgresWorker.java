...
@Slf4j
public class HotAccountPostgresWorker {

    static final String STAGE_TABLE_NAME_PREFIX = "stage_record_entry";

    private final PostgreSqlEntryRecordBatchRingBufferHandler postgresRingBuffer;
    private final Map<Integer, PostgresBatchProcessor> stageTableProcessorsMap;
    private final PostgresCheckpointWriter checkpointWriter;
    ...
    public HotAccountPostgresWorker(
        ...
        this.postgresRingBuffer = new PostgreSqlEntryRecordBatchRingBufferHandler(
            ringBufferSegment,
            postgreSQLConfiguration.directCopyBatchRecordsCount()
        );
    ...
    public PostgreSqlEntryRecordBatchRingBufferHandler postgresRingBuffer() {
...
//            };
        ...
        while (isRunning) {
            try {
                ...
                final PostgresBatchProcessor processor = stageTableProcessorsMap.get(stageTableProcessorIndex);
